...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Type-Safe Client', link: '/guide/client' },
      { text: 'EventBus & Microservices', link: '/guide/eventbus' },
    ...
    sidebar: [
      ...
      {
        text: '🚀 Advanced Architecture & SDKs',
        items: [
          { text: 'Schema Validation & Type Safety', link: '/guide/validation' },
          { text: 'Type-Safe RPC Client SDK', link: '/guide/client' },
          { text: 'Microservices & EventBus', link: '/guide/eventbus' },
          { text: 'OOP & Decorators Architecture', link: '/guide/decorators' },
          { text: 'Express Middleware Shim', link: '/guide/express-compat' },
        ],
      },
      {
        text: '⚙️ Middlewares & Security',
        items: [
      ...
      {
        text: '🛠️ Documentation & Releases',
        items: [
          { text: 'In-Memory Testing (app.inject)', link: '/guide/testing' },
          { text: 'Changelog & Version History', link: '/guide/changelog' },
