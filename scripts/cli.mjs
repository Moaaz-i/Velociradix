...
if (
  ...
  console.log("Usage:");
  console.log(
    "  npx create-velociradix-app <project-name> [--template ts|js|express-bridge|rest-api]",
  );
  console.log("  npx velociradix init\n");
  console.log("Templates:");
  console.log(
    "  js              - Clean JavaScript ES Modules starter (Default)",
  );
  console.log("  ts              - Strict TypeScript starter with types");
  console.log(
    "  express-bridge  - Express Router & Middleware compatibility starter",
  );
  console.log(
    "  rest-api        - Full REST API with JWT Auth, Postman UI, & Zod Validation\n",
  );
  process.exit(0);
}
...
console.log(
  `🚀 Creating new \x1b[32mVelociradix (${template.toUpperCase()})\x1b[0m project in \x1b[33m${targetDir}\x1b[0m...\n`,
);
